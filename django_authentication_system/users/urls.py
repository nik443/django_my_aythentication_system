...
urlpatterns = [
    path('login/', MyLoginView.as_view(), name='login'), # мы переопределяем маршрут login, который по умолчанию используется в 'django.contrib.auth.urls', для этого мы в списке url располагаем его выше 
